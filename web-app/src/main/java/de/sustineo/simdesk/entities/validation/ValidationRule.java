...
public enum ValidationRule {
    ...
    DRIVER_CATEGORIES_MISSING("validateDriverCategories", "Missing driver categories", "Check if driver categories are set if overrideDriverInfo is set to 1.");
    ...
    public static ValidationRule[] enabledByDefault() {
        return new ValidationRule[]{
                RACE_NUMBERS_INVALID,
                STEAM_IDS_INVALID,
                GRID_POSITIONS_INVALID,
                BALLAST_INVALID,
                RESTRICTOR_INVALID,
        };
    }
