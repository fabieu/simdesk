...
`;let Qe=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[Si,E`
        #toggle {
          display: block;
        }
    ...
    `];Ot=Na([F("vaadin-dev-tools-shim")],Ot);const xi=E`
  .popup {
    width: auto;
    position: fixed;
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const $i=[];function Ti(t){return t&&Object.prototype.hasOwnProperty.call(t,"__themes")}function tl(t){return Ti(customElements.get(t))}function ol(t=[]){return[t].flat(1/0).filter(e=>e instanceof Io?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function Ni(t,e,o={}){t&&tl(t)&&console.warn(`The custom element definition for "${t}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=ol(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(t,e,o):$i.push({themeFor:t,styles:e,include:o.include,moduleId:o.moduleId})}function To(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():$i}function nl(t,e){return(t||"").split(" ").some(o=>new RegExp(`^${o.split("*").join(".*")}$`,"u").test(e))}function il(t=""){let e=0;return t.startsWith("lumo-")||t.startsWith("material-")?e=1:t.startsWith("vaadin-")&&(e=2),e}function Pi(t){const e=[];return t.include&&[].concat(t.include).forEach(o=>{const n=To().find(i=>i.moduleId===o);n?e.push(...Pi(n),...n.styles):console.warn(`Included moduleId ${o} not found in style registry`)},t.styles),e}function sl(t,e){const o=document.createElement("style");o.innerHTML=t.map(n=>n.cssText).join(`
`),e.content.appendChild(o)}function rl(t){const e=`${t}-default-theme`,o=To().filter(n=>n.moduleId!==e&&nl(n.themeFor,t)).map(n=>({...n,styles:[...Pi(n),...n.styles],includePriority:il(n.moduleId)})).sort((n,i)=>i.includePriority-n.includePriority);return o.length>0?o:To().filter(n=>n.moduleId===e)}const fl=t=>class extends el(t){static finalize(){if(super.finalize(),this.elementStyles)return;const o=this.prototype._template;!o||Ti(this)||sl(this.getStylesForThis(),o)}static finalizeStyles(o){const n=this.getStylesForThis();return o?[...super.finalizeStyles(o),...n]:n}static getStylesForThis(){const o=Object.getPrototypeOf(this.prototype),n=(o?o.constructor.__themes:[])||[];this.__themes=[...n,...rl(this.is)];const i=this.__themes.flatMap(s=>s.styles);return i.filter((s,r)=>r===i.lastIndexOf(s))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`;Ni("",qo,{moduleId:"lumo-typography"});zt("typography-props",dl);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cl=E`
  ${li(qo.cssText.replace(/,\s*:host/su,""))}
`;zt("typography",cl,!1);const hl=t=>{const e=[];t!==document&&(e.push(Kn(Ho.cssText,"",t,!0)),e.push(Kn(qo.cssText,"",t,!0)))},ul=hl;ul(document);export{nr as D,je as F,A as L,tr as P,fl as T,Ne as U,x as _,zt as a,be as b,E as c,or as d,Ni as e,el as f,Ho as g,v as h,qo as i,J as j,_r as k,wr as l,k as n,Ae as r,Te as s,$i as t,li as u,P as y};
