...
public interface DriverMapper {
    ...
    @Select("SELECT player_id FROM leaderboard_driver WHERE car_id = #{carId} AND session_id = #{sessionId}")
    List<String> findPlayerIdsBySessionIdAndCarId(Integer sessionId, Integer carId);
