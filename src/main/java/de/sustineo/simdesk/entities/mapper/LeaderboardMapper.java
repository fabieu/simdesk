...
public interface LeaderboardMapper {
    @Insert("""
            INSERT INTO simdesk.leaderboard_line (session_id, ranking, cup_category, car_id, car_group, car_model_id, ballast_kg, race_number, best_lap_time_millis, best_split1_millis, best_split2_millis, best_split3_millis, total_time_millis, lap_count)
    ...
    @Insert(databaseId = DatabaseVendor.SQLITE, value = """
            INSERT INTO leaderboard_line (session_id, ranking, cup_category, car_id, car_group, car_model_id, ballast_kg, race_number, best_lap_time_millis, best_split1_millis, best_split2_millis, best_split3_millis, total_time_millis, lap_count)
            VALUES (#{sessionId}, #{ranking}, #{cupCategory}, #{carId}, #{carGroup}, #{carModelId}, #{ballastKg}, #{raceNumber}, #{bestLapTimeMillis}, #{bestSplit1Millis}, #{bestSplit2Millis}, #{bestSplit3Millis}, #{totalTimeMillis}, #{lapCount})
            """)
    ...
    @Insert("""
            INSERT INTO simdesk.leaderboard_driver (session_id, car_id, player_id, drive_time_millis)
