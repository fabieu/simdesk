...
public interface LeaderboardMapper {
    @Insert("INSERT INTO leaderboard_lines (session_id, ranking, cup_category, car_id, car_group, car_model_id, ballast_kg, race_number, best_lap_time_millis, best_split1_millis, best_split2_millis, best_split3_millis, total_time_millis, lap_count) " +
    ...
    @Insert("INSERT INTO leaderboard_drivers (session_id, car_id, player_id, drive_time_millis) " +
