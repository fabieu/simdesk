...
public class DriverRankingRenderer {
    public static Renderer<DriverRanking> createLapTimeRenderer(DriverRanking topDriverRanking) {
        ...
        return LitRenderer.<DriverRanking>of(TIMING_TEMPLATE)
                ...
                .withProperty(TIMING_TEMPLATE_GAP, driverRanking -> FormatUtils.formatLapTime(driverRanking.getLapTimeMillis() - fastestTimeMillis))
    ...
    public static Renderer<DriverRanking> createSplit1Renderer(DriverRanking topDriverRanking) {
        ...
        return LitRenderer.<DriverRanking>of(TIMING_TEMPLATE)
                ...
                .withProperty(TIMING_TEMPLATE_GAP, driverRanking -> FormatUtils.formatLapTime(driverRanking.getSplit1Millis() - fastestTimeMillis))
    ...
    public static Renderer<DriverRanking> createSplit2Renderer(DriverRanking topDriverRanking) {
        ...
        return LitRenderer.<DriverRanking>of(TIMING_TEMPLATE)
                ...
                .withProperty(TIMING_TEMPLATE_GAP, driverRanking -> FormatUtils.formatLapTime(driverRanking.getSplit2Millis() - fastestTimeMillis))
    ...
    public static Renderer<DriverRanking> createSplit3Renderer(DriverRanking topDriverRanking) {
        ...
        return LitRenderer.<DriverRanking>of(TIMING_TEMPLATE)
                ...
                .withProperty(TIMING_TEMPLATE_GAP, driverRanking -> FormatUtils.formatLapTime(driverRanking.getSplit3Millis() - fastestTimeMillis))
