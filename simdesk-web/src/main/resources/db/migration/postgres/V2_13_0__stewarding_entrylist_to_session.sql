...
UPDATE simdesk.stewarding_entrylist SET session_id = (SELECT id FROM simdesk.stewarding_session WHERE race_weekend_id = simdesk.stewarding_entrylist.race_weekend_id LIMIT 1);
