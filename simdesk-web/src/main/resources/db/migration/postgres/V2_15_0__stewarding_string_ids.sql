...
DROP TABLE IF EXISTS simdesk.stewarding_appeal;
DROP TABLE IF EXISTS simdesk.stewarding_decision;
DROP TABLE IF EXISTS simdesk.stewarding_incident_involved_entry;
DROP TABLE IF EXISTS simdesk.stewarding_incident;
DROP TABLE IF EXISTS simdesk.stewarding_entrylist_driver;
DROP TABLE IF EXISTS simdesk.stewarding_entrylist_entry;
DROP TABLE IF EXISTS simdesk.stewarding_entrylist;
DROP TABLE IF EXISTS simdesk.stewarding_session;
DROP TABLE IF EXISTS simdesk.stewarding_race_weekend;
DROP TABLE IF EXISTS simdesk.stewarding_series;
DROP TABLE IF EXISTS simdesk.stewarding_penalty_definition;
DROP TABLE IF EXISTS simdesk.stewarding_penalty_catalog;
DROP TABLE IF EXISTS simdesk.stewarding_reasoning_template;
DROP TABLE IF EXISTS simdesk.stewarding_track;

CREATE TABLE simdesk.stewarding_track
(
...
CREATE TABLE simdesk.stewarding_penalty_catalog
(
    id          VARCHAR(12) PRIMARY KEY NOT NULL,
    name        VARCHAR(255)            NOT NULL,
    description TEXT,
...
CREATE TABLE simdesk.stewarding_penalty_definition
(
    id              VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_reasoning_template
(
    id            VARCHAR(12) PRIMARY KEY NOT NULL,
    name          VARCHAR(255)            NOT NULL,
    category      VARCHAR(100),
...
CREATE TABLE simdesk.stewarding_series
(
    id                  VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_round
(
    id         VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_session
(
    id           VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_entrylist
(
    id          VARCHAR(12) PRIMARY KEY NOT NULL,
    round_id    VARCHAR(12),
...
CREATE TABLE simdesk.stewarding_entrylist_entry
(
    id           VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_entrylist_driver
(
    id         VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_incident
(
    id                   VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_incident_involved_entry
(
...
CREATE TABLE simdesk.stewarding_decision
(
    id                    VARCHAR(12) PRIMARY KEY NOT NULL,
...
CREATE TABLE simdesk.stewarding_appeal
(
    id                   VARCHAR(12) PRIMARY KEY NOT NULL,
